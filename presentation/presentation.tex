...
\begin{frame}	
	\begin{itemize}[<alert@+>]
		\item Big differences in question quality are found across countries
		\item Previous explanations for the differences we (Oberski ea 2007) sought for were
			\begin{itemize}[<alert@+>]
				\item the complexity of the sentences in different languages
				\item translation errors
				\item different implementations of the experiments used to estimate the quality
			\end{itemize}
		\item None of these possible reasons could sufficiently explain the large differences found
		\item Therefore we now consider another possible explanation:
		\item Categorization error.
	\end{itemize}
\end{frame}	
...
\begin{frame}
	...
	\pause\includegraphics[width=\textwidth]{i/response-model.pdf}\\
\end{frame}
...
\begin{frame}	
	...
	\begin{itemize}[<alert@+>]
		\item The square of the quality coefficient $q^2$ is called the 'total quality' of a measure.
...
\begin{frame}
   ...
   \includegraphics[height=7cm]{i/response_categorical.pdf}
\end{frame}
...
\vspace{1em}\begin{footnotesize}
	\begin{columns}[T]
		\begin{column}{3cm}\centering\includegraphics[width=2.55cm]{i/uvt_fac.jpg} 

Tilburg\end{column}
		\begin{column}{3cm}\centering\includegraphics[width=2.5cm]{i/esade_fac.jpg} 
...
\bibitem{Oberski2007}
Oberski, Daniel, Willem Saris, and Jacques Hagenaars
\newblock Why are there Differences in Measurement Quality across Countries?
\newblock in: \emph{Measuring Meaningful Data in Social Research}. G. Loosveldt, M. Swyngedouw \& B. Cambr\'e (eds.). Leuven: Acco. 2007.
