...
\title{Separating random, systematic, and categorisation errors in surveys}
...
\begin{frame}
   ...
   \includegraphics[height=7cm]{i/response-categ.pdf}
\end{frame}
...
\end{equation*}
\item However, we have seen that $y$ is itself a categorization of an unobserved continuous variable ($c$), and therefore the above equation can be `decomposed' into
\item \begin{equation*}
