...
\begin{table}\centering\caption{Quality ($q^2$) and method effects ($m$) according to the continuous and categorical models, with categorisation factors for the experiment on opinions about the role of men and women in society.\label{tab:women}}\begin{tabular}{lllrrr}
\hline
...
\caption{Boxplot of the categorisation factor for the high and low quality group.}
\end{minipage}
\end{figure}
