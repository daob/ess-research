...
\begin{figure}[bth] \centering \includegraphics[width=.9\textwidth]{i/meta-scatter} \caption{Scatterplot of the categorisation factor ($c$) and the total quality of a measure ($q_{cont.}^2$) across the experiments.\label{fig:meta_scatter}} \end{figure}
...
\begin{figure}[bth] \centering \includegraphics[width=.8\textwidth]{i/predict_q2.pdf} \caption{Scatterplot of the categorisation factor ($c$) and the total quality of a measure ($q_{cont.}^2$) by experiment. The prediction line of the model $\ln(q^2) = \alpha + \beta \ln(c)$, as estimated for each experiment separately, is also given.\label{fig:predict_q2.pdf}} \end{figure}
