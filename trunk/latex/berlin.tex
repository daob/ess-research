...
Conversely, the right hand side shows a latent response variable that has been categorised with very unequal thresholds. At the second step there is almost no extra error, while at the first and third steps the errors are much larger. Here a transformation occurs because the distances between the expectations in the categories are not equal to the distances between the categories if the numbers 0 through 3, or any other set of numbers with equal distances, are assigned to them.
