...
\author{Daniel Oberski\\Willem E. Saris\\ESADE, Universitat Ramon Llull\\\\Jacques Hagenaars\\Tilburg University}
...
In this paper we will perform only a basic invariance tests on thresholds. If the thresholds are equal then there categorisation error is not a likely cause of differences in quality. However, we do not continue with tests for invariance on loadings and error variance, but will compare the results of two different models.
