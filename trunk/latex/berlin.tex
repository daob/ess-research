...
\marginpar{give an overview of the paper here.}
...
\begin{figure}[tbh] \centering \includegraphics[width=\textwidth]{i/meta-scatter} \caption{Scatterplot of the categorisation factor ($c$) and the total quality of a measure ($q_{cont.}^2$) across the experiments.\label{fig:meta_scatter}} \end{figure}

Figure \ref{fig:meta_scatter} shows that categorisation factors above unity were mostly found for questions with a high quality. This means that high quality coefficients from the continuous model tend to be lower in the categorical model, and the other way around-.
