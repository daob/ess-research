...
\end{equation*}
\item However, we have now seen that $y$ is itself a categorization of an unobserved continuous variable ($c$), and therefore the above equation can be `decomposed' into
\item \begin{equation*}
...
\frametitle{Correction for categorisation: conclusions}
	...
	\begin{itemize}[<alert@+>]
		...
		\item If this happens more in some countries than others, differences in quality will result;
...
\subsection{Does categorisation explain differences across countries?}
...
\frametitle{Conclusions}
	...
	\begin{itemize}[<alert@+>]
				...
				\item Differences in use of the scale play a large role in causing differences between countries.
			\end{itemize}
\end{frame}
...
\begin{frame}
That's it for now. Moltes gràcies per la seva atenció!
